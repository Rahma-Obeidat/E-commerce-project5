<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add Product.aspx.cs" Inherits="E_commerce.Add_Product" %>
    ...
    <form id="form1" runat="server">
        <div class="big_div">
            <div class="div_form">
                ...
                <asp:Button ID="Button2" runat="server" Text="Add Product"  CssClass="btn_add" OnClick="Button2_Click"/><asp:Button ID="Button3" runat="server" Text="Show All Product"  CssClass="btn_show"/>
